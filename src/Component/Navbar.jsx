      ...
      <div className="w-[100%] h-[100%]  flex justify-between items-center ">
        <div className="w-auto h-[100%] flex justify-center items-center gap-2  ">
          ...
          >
            ...
            type="button"
              onClick={handlesearh}
              className="h-[2.5rem] font-medium rounded-r-2xl border-none bg-gray-100	dark:bg-[#1e1e1e]"
            >
        ...
        <div className="w-auto h-[100%] flex justify-center items-center gap-2 ">
          <form action="" className="relative sm:hidden block">
            <i
              ...
              className="fa-solid fa-magnifying-glass text-gray-800 dark:text-gray-300 	text-lg md:text-xl cursor-pointer p-2 "
            ></i>
          </form>
